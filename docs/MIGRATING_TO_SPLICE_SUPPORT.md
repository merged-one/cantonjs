...
This note is for existing `cantonjs` users adopting the new Splice packages introduced in the `0.2.x` line.
...
See [compatibility.md](./compatibility.md) for the support matrix and release-line policy.
